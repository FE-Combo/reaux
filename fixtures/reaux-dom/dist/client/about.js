...
var Main_Main = /** @class */ (function (_super) {
    Object(tslib_es6["b" /* __extends */])(Main, _super);
    function Main() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Main.prototype.render = function () {
        var dispatch = this.props.dispatch;
        var actions = about().actions;
        return (react["createElement"]("div", null,
            this.props.name,
            react["createElement"]("button", { onClick: function () { return dispatch(actions.test()); } }, "change")));
    };
    return Main;
}(react["PureComponent"]));
var mapStateToProps = function (state) {
    var _a;
    return {
        name: (_a = state === null || state === void 0 ? void 0 : state.about) === null || _a === void 0 ? void 0 : _a.name,
    };
};
...
/* harmony default export */ var about = __webpack_exports__["default"] = (Object(reaux_dom["register"])(new about_ActionHandler("about", initState), component_Main));
